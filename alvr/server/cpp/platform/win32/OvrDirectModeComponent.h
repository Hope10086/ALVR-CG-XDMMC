...
private:
	...
	vr::HmdQuaternion_t m_preFrameGazeRotation;
	vr::HmdVector3_t m_preFrameGazeDirection;

	vr::HmdVector3d_t m_framePosePosition;
	vr::HmdQuaternion_t m_frameGazeRotation;
	vr::HmdVector3_t m_frameGazeDirection;
